...
\chapter{Wprowadzenie do mikroserwisów}
  ...
  Komunikacja między mikroserwisami zachodzi przy użyciu protokołów siecowych neutralnych w ujęciu technologicznym takich jak HTTP.
  
  Podział aplikacji na serwisy pozwala na wykonywanie prac nad konkretnymi funkcjonalnościami aplikacji bez potencjalnego ryzyka naruszenia kodu odpowiedzialnego za inne funkcjonalności. Innymi zaletami tego rozwiązania są:
  ...
  \begin{enumerate}
    ...
    \item skalowalność - nowe funkcjonalności można dodawać z nowymi serwisami, a poszczególne serwisy można rozszerzać nie naruszając logiki innych serwisów.
  \end{enumerate}
